...
# remove addgene plasmids with 70 or more conflicts in the target domain region or < 50% seq identity
...
print 'Number of addgene plasmids with < 70 conflicts in the target domain region and > 50% seq identity:', len(selected_addgene_plasmids)
