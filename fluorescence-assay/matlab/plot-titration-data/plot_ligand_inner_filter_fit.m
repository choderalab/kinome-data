...
% Load data.
filename = '../../2012-05-11/2012-05-11 plate A8 mid-prep 3  bosutinib titration after adding Src.txt';
...
ligand_concentrations = 10e-6 * 2.^(-(0:11)); % ligand concentrations in cell (M)
...
filename = 'primary inner filter effect fit - bosutinib in buffer.eps';
