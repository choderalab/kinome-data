function [Kd, protein_concentration, computed_ligand_fluorescence, computed_mixture_fluorescence] = fit_titration_data3(initial_volume, initial_protein_concentration_estimate, injection_volumes, injection_concentrations, observed_ligand_fluorescence, observed_mixture_fluorescence)
...
computed_ligand_fluorescence = ligand_fluorescence * ligand_quantities + buffer_fluorescence * well_volumes;
computed_mixture_fluorescence = complex_fluorescence * well_volumes .* complex_concentration(protein_quantity ./ well_volumes, ligand_quantities ./ well_volumes, Kd) + protein_fluorescence * well_volumes .* protein_concentration(protein_quantity ./ well_volumes, ligand_quantities ./ well_volumes, Kd) + ligand_fluorescence * well_volumes .* ligand_concentration(protein_quantity ./ well_volumes, ligand_quantities ./ well_volumes, Kd) + buffer_fluorescence * well_volumes;
