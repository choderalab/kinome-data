...
with open('kinase_constructs-sgc_and_hip-unfiltered.html', 'w') as html_file:
    html_file.write( template.render(title=title, subtitle=subtitle, maintable=table_content, display_filters=True) )
